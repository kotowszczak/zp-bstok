...
if ( ! class_exists( 'Zp_Bialystok_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Zp Bialystok 1.0
	 */
	class Zp_Bialystok_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'zpbialystok' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'zpbialystok' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'zpbialystok' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'zpbialystok' ),
						'full'    => esc_html__( 'Full text', 'zpbialystok' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-zp-bialystok-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Zp_Bialystok_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Zp_Bialystok_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'zpbialystok' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
